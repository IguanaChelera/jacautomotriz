...
<head>
    ...
    <!-- DataTables CSS -->
    <link rel="stylesheet" href="{{ secure_asset('DataTables/datatables.min.css') }}" />
    <!-- Tu CSS -->
    <link rel="stylesheet" href="{{ secure_asset('assets/styles.css') }}" />
    <link rel="stylesheet" href="{{ secure_asset('bootstrap-5.3.3-dist/css/bootstrap-icons.css') }}">
